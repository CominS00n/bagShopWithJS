...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3983434942ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bagshop&table=admin">`bagshop`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bagshop&table=member">`bagshop`.`member`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bagshop&table=product">`bagshop`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=da_mydatabase&table=tb_mytable">`da_mydatabase`.`tb_mytable`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=da_mydatabase&table=accounts">`da_mydatabase`.`accounts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bagshop&table=peoduct">`bagshop`.`peoduct`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="404427555d6b65536e2155256c2d2554">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="bagshop" targettable="product">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `product`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="da_mydatabase" targettable="accounts">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `accounts`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="da_mydatabase" targettable="tb_mytable">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_mytable`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bagshop" targettable="product">
                            <div class="action_content">
...
ORDER BY `product`.`pd_ID` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bagshop" targettable="product">
                            <div class="action_content">
...
ORDER BY `product`.`pd_ID` ASC</span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `member` (
  ...
  `address` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bagshop" targettable="product">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `product`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="bagshop" targettable="member">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `member`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bagshop" targettable="product">
                            <div class="action_content">
...
ORDER BY `product`.`pd_ID` ASC</span>
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `member` WHERE `member`.`memberID` = 4</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bagshop" targettable="member">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `member`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="bagshop" targettable="admin">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
