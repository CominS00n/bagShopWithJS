...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bagshop&table=product">`bagshop`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bagshop&table=member">`bagshop`.`member`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bagshop&table=admin">`bagshop`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=da_mydatabase&table=tb_mytable">`da_mydatabase`.`tb_mytable`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=da_mydatabase&table=accounts">`da_mydatabase`.`accounts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bagshop&table=peoduct">`bagshop`.`peoduct`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
ORDER BY `product`.`pd_ID` ASC</span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `product` ORDER BY `pd_ID` ASC  </span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bagshop" targettable="product">
                            <div class="action_content">
